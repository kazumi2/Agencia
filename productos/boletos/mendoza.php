...
$codigo_reserva = 'MDZ-' . str_pad($reserva_id, 6, '0', STR_PAD_LEFT);
?>

<div class="container py-4">
    <div class="card border-0 shadow-sm">
        <!-- Encabezado con diseño temático de Mendoza -->
        <div class="card-header bg-gradient-wine text-white">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="mb-1"><i class="bi bi-building"></i> Confirmación de Reserva</h2>
                    <p class="mb-0"><i class="bi bi-geo-alt"></i> Mendoza, Argentina</p>
                </div>
                <div class="col-md-4 text-end">
                    <span class="badge bg-light text-dark fs-6">N° <?= $codigo_reserva ?></span>
                    <p class="mb-0 mt-1"><small>Emitido: <?= date('d/m/Y H:i') ?></small></p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="row mb-4">
                <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <div class="text-center mt-3">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?= urlencode("Hotel:{$reserva['hotel_nombre']},Reserva:$codigo_reserva,Fecha:{$fecha_entrada->format('d/m/Y')}") ?>" 
                             alt="Código QR" class="img-thumbnail border-wine">
                ...
                <div class="col-md-8">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <h3 class="text-wine"><?= htmlspecialchars($reserva['hotel_nombre']) ?></h3>
                            <div class="mb-2">
                                <?= str_repeat('<i class="bi bi-star-fill text-warning"></i>', substr_count($reserva['categoria'], '★')) ?>
                                <span class="badge bg-wine ms-2"><?= $reserva['categoria'] ?></span>
                            </div>
                        </div>
                        <span class="badge bg-<?= $reserva['precio'] > 100000 ? 'danger' : 'success' ?>">
                            <?= $reserva['precio'] > 100000 ? 'Premium' : 'Standard' ?>
                        </span>
                    </div>
            ...
            <div class="row mt-4">
                <div class="col-md-6">
                    <div class="card border-wine mb-4">
                                ...
                                <div class="col-md-6">
                                    <ul class="list-unstyled">
                                        <?php foreach($columna as $servicio): ?>
                                            <li class="mb-2"><i class="bi bi-check-circle-fill text-wine"></i> <?= htmlspecialchars(trim($servicio)) ?></li>
                                        <?php endforeach; ?>
                                    </ul>
                                </div>
                                <?php endforeach; ?>
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body">
                            ...
                            <div class="alert alert-warning small">
                                <h6><i class="bi bi-lightbulb"></i> Recomendaciones para Mendoza</h6>
                                <ul class="mb-0">
                                    <li>Reserve tours en bodegas con anticipación</li>
                                    <li>Protector solar y gafas son esenciales</li>
                                    <li>Pruebe el famoso Malbec local</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card-footer bg-light">
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <div>
                    <button onclick="window.print()" class="btn btn-outline-wine me-2">
                        <i class="bi bi-printer"></i> Imprimir
                    </button>
                    <button class="btn btn-outline-wine" id="saveToWallet">
                        <i class="bi bi-wallet2"></i> Guardar en Wallet
                    </button>
                </div>
                <div>
                    <a href="mendoza.php" class="btn btn-wine">
...
<style>
    .bg-gradient-wine {
        background: linear-gradient(135deg, #6a0dad 0%, #8b0000 100%);
    }
