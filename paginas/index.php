 ...
 <!-- Navegador -->
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><a class="nav-link" href="..\usuario\login.php"><img src="../assets/img/iconos/usuario.png" alt="Iniciar sesión" style="width: 24px; height: 24px;"></a></li>
        </ul>
      </div>
    </div>
  </nav>

  <section class="hero-y-guia text-center py-5" style="background: url('../assets/img/que\ gran\ fondo.jpg') center center/cover no-repeat; color: white;">
  <div class="container bg-dark bg-opacity-75 p-4 rounded">
    ...
    <div class="row mt-4">
      ...
      <div class="col-md-4">
        <div class="mb-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="white" class="bi bi-card-checklist" viewBox="0 0 16 16">
            <path d="M10.854 6.854a.5.5 0 0 0-.708-.708L8.5 7.793 7.354 6.646a.5.5 0 1 0-.708.708L8.5 9l2.354-2.146z"/>
            <path d="M14 4.5V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4.5H14zm1-1h-1V2a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v1H6V2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v1H1a1 1 0 0 0-1 1v1h16V4.5a1 1 0 0 0-1-1z"/>
          </svg>
        </div>
      ...
      <div class="col-md-4">
        <div class="mb-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="white" class="bi bi-cash-stack" viewBox="0 0 16 16">
            <path d="M14 2a1 1 0 0 1 1 1v1H1V3a1 1 0 0 1 1-1h12zm1 2H1v5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4zM1 11.5a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5V10H1v1.5z"/>
          </svg>
        </div>
